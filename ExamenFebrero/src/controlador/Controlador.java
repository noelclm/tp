...
import excepciones.MundoNoCreadoException;
...
public class Controlador {
	...
	private MundoSimple mundo = null;
	...
	public String iniciar() throws MundoException {
		if(this.mundo == null)
			throw new MundoNoCreadoException();
	 ...
	 * @return String
	 */
	public String jugar(MundoSimple mundo) {
		this.mundo = mundo;
