...
public class MundoComplejo extends Comando{
	 ...
	 */
	public MundoComplejo(int filas, int columnas, int celulasComplejas, int celulasSimples) {
	...
	public Comando parsea(String[] cadenaComando) {
		...
		if (cadenaComando[0].equals("jugar") && cadenaComando[1].equals("complejo") && cadenaComando.length == 6){
			...
			Comando comando = new MundoComplejo(filas,columnas,celulasSimples,celulasComplejas);
			return comando;
		}else{
			return null;
		}
